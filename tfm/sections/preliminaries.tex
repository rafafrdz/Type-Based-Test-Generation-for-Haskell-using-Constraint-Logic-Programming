...
This section will be short. Prolog is hugely flexible concerning its grammar and the expressions that one can define. This helps do syntax transformation between Haskell to Prolog, and vice versa.\\
%%
