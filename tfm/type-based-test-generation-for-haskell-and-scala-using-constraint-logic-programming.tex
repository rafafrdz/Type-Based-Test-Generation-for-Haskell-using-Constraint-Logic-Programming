...
\begin{example}[Binary Search Tree]
	...
	\lstinputlisting[language=Haskell, label=bst-haskell-monotype]{code/chapter3/monotypes/bst-monotype.hs}
	We can observe it is a recursive definition, so here:
	\begin{itemize}
...
\begin{example}[SomeWeird]
	...
	\lstinputlisting[language=Haskell, label=bst-haskell-monotype]{code/chapter3/monotypes/someweird-monotype.hs}
	We can observe it is a recursive definition, so here:
	\begin{itemize}
...
\begin{example}[Rose Tree]
	...
	\lstinputlisting[language=Haskell, label=rstree-haskell-monotype]{code/chapter3/monotypes/rstree-monotype.hs}
...
\end{itemize}
So finally, we can translate the Haskell definition showed above to the following Prolog program:\\
\lstinputlisting[language=Prolog, label=binary-search-tree-prolog-monotype-boundery]{code/chapter3/monotypes-boundery/mylistbool-boundery.pl}
...
\end{itemize}
So finally, we can translate the Haskell definition showed above to the following Prolog program:\\
\lstinputlisting[language=Prolog, label=binary-search-tree-prolog-monotype-boundery]{code/chapter3/monotypes-boundery/bst-boundery.pl}
...
\begin{example}[SomeWeird]
	Let's suppose the following Haskell ADT definition:
	\lstinputlisting[language=Haskell, label=someweird-haskell-monotype]{code/chapter3/monotypes/someweird-monotype.hs}
	Using $\psi$, in the las examples \ref{ch:monomorphic-types-examples} we obtain:
\begin{lstlisting}[language=Prolog]
someweird(nil1).																														%% rule 1
someweird(nil2).																														%% rule 2
...
\end{itemize}
So finally, we can translate the Haskell definition showed above to the following Prolog program:\\
\lstinputlisting[language=Prolog, label=someweird-prolog-monotype-boundery]{code/chapter3/monotypes-boundery/someweird-boundery.pl}
